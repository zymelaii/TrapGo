#ifndef TIMELAPSESAMPLE_H
#define TIMELAPSESAMPLE_H
...
class TimeLapseSample : public AbstractOpenGLSample {
	Q_OBJECT

public:
	explicit TimeLapseSample(QWidget* parent = nullptr);
	~TimeLapseSample();
